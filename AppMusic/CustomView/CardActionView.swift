...
class CardActionView: UIView {
    ...
    private func setupViews() {
        ...
        self.moreView.addSubview(self.moredBtn)
    }
    ...
    private func setupConstraints(){
        ...
        NSLayoutConstraint.activate([
            ...
            self.moredBtn.centerXAnchor.constraint(equalTo: self.moreView.centerXAnchor),
            self.moredBtn.centerYAnchor.constraint(equalTo: self.moreView.centerYAnchor),
            self.moredBtn.widthAnchor.constraint(equalToConstant: 45),
            self.moredBtn.heightAnchor.constraint(equalToConstant: 45),
